...
//Connect to the server and select the database
            ...
            if (isset($_POST['ModificaCliente']) && !empty($_POST['name']) 
               && !empty($_POST['family'])) {
				  ...
				  // Define my variables: 
				  // INSERT INTO `uln6tjuc_libdog`.`libdog_Anagrafica_Clienti` (`name`, `family`, `town`, `zip`, `prov`, `mail`, `mobile`, `phone`, `CF`) VALUES (...);
					$name=$_POST['name']; 
					$family=$_POST['family']; 
...
// To protect MySQL injection (more detail about MySQL injection)
                  ...
                  $sql1 = "UPDATE `uln6tjuc_libdog`.`libdog_Anagrafica_Clienti` SET `name`='$name', `family`='$family', `address`='$address',`town`='$town', `zip`='$zip', `prov`='$prov', `mail`='$mail',`mail2`='$mail2', `mobile`='$mobile', `mobile2`='$mobile2', `phone`='$phone', `CF`='$CF' WHERE `idlibdog_Anagrafica_Clienti`='$ownerid';";
      ...
      <?php
		$sql6 = "SELECT * FROM `uln6tjuc_libdog`.`libdog_Anagrafica_Clienti` WHERE `idlibdog_Anagrafica_Clienti`='$ownerid';";
...
// To protect MySQL injection (more detail about MySQL injection)
      ...
      <?php
		$sql5 = "SELECT * FROM `uln6tjuc_libdog`.`libdog_Anagrafica_Cani` WHERE `idlibdog_Anagrafica_Cani`='$dogid';";
