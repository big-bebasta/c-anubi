...
//Connect to the server and select the database
            ...
            if (isset($_POST['Inserisci']) && !empty($_POST['name']) 
               && !empty($_POST['family'])) {
				  ...
				  // Define my variables: 
				  // INSERT INTO `uln6tjuc_libdog`.`libdog_Anagrafica_Clienti` (`name`, `family`,`address`, `town`, `zip`, `prov`, `mail`, `mobile`, `phone`, `CF`, `mail2`) VALUES (...);
					$name=$_POST['name']; 
					$family=$_POST['family']; 
...
// To protect MySQL injection (more detail about MySQL injection)
                  ...
                  $sql2 = "INSERT INTO `uln6tjuc_libdog`.`libdog_Anagrafica_Clienti` (`name`, `family`,`address`,`town`, `zip`, `prov`, `mail`,`mail2`, `mobile`,`mobile2`, `phone`, `CF`) VALUES ('$name', '$family','$address', '$town', '$zip', '$prov', '$mail','$mail2','$mobile','$mobile2', '$phone', '$CF');";
      ...
      <div class = "container">
            ...
            <form action="newclient.php" method='post' id='login'>
			  ...
			  <td></td> </tr>
					...
					<table align=center border=2> <tr><td>id_Clienti</td><td>name</td><td>Cognome</td><td>Paese</td><td>Indirizzo</td><td>CAP</td><td>Provincia</td><td>mail</td><td>mail 2</td><td>Cellulare</td><td>Cellulare 2</td><td>Telefono</td><td>Codice Fiscale</td></tr>
						<?php 
