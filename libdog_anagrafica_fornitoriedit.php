...
$libdog_anagrafica_fornitori_edit = NULL; // Initialize page object first

class clibdog_anagrafica_fornitori_edit extends clibdog_anagrafica_fornitori {
	...
	// Page object name
	var $PageObjName = 'libdog_anagrafica_fornitori_edit';
	...
	function Page_Init() {
		...
		$this->idlibdog_Anagrafica_Fornitori->SetVisibility();
		$this->idlibdog_Anagrafica_Fornitori->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idlibdog_Anagrafica_Fornitori->CurrentValue == "") {
			$this->Page_Terminate("libdog_anagrafica_fornitorilist.php"); // Invalid key, return to list
		}
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->idlibdog_Anagrafica_Fornitori->FldIsDetailKey)
			$this->idlibdog_Anagrafica_Fornitori->setFormValue($objForm->GetValue("x_idlibdog_Anagrafica_Fornitori"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->idlibdog_Anagrafica_Fornitori->CurrentValue = $this->idlibdog_Anagrafica_Fornitori->FormValue;
	...
	function RenderRow() {
		...
		$this->mail2->ViewCustomAttributes = "";
			...
			// idlibdog_Anagrafica_Fornitori
			$this->idlibdog_Anagrafica_Fornitori->LinkCustomAttributes = "";
			$this->idlibdog_Anagrafica_Fornitori->HrefValue = "";
			$this->idlibdog_Anagrafica_Fornitori->TooltipValue = "";
			...
			// idlibdog_Anagrafica_Fornitori
			$this->idlibdog_Anagrafica_Fornitori->EditAttrs["class"] = "form-control";
			$this->idlibdog_Anagrafica_Fornitori->EditCustomAttributes = "";
			$this->idlibdog_Anagrafica_Fornitori->EditValue = $this->idlibdog_Anagrafica_Fornitori->CurrentValue;
			$this->idlibdog_Anagrafica_Fornitori->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// PI
			$this->PI->SetDbValueDef($rsnew, $this->PI->CurrentValue, NULL, $this->PI->ReadOnly);
			...
			// prov
			$this->prov->SetDbValueDef($rsnew, $this->prov->CurrentValue, NULL, $this->prov->ReadOnly);
			...
			// CF
			$this->CF->SetDbValueDef($rsnew, $this->CF->CurrentValue, NULL, $this->CF->ReadOnly);

			// mobile2
			$this->mobile2->SetDbValueDef($rsnew, $this->mobile2->CurrentValue, NULL, $this->mobile2->ReadOnly);

			// mail2
			$this->mail2->SetDbValueDef($rsnew, $this->mail2->CurrentValue, "", $this->mail2->ReadOnly);
...
// Create page object
if (!isset($libdog_anagrafica_fornitori_edit)) $libdog_anagrafica_fornitori_edit = new clibdog_anagrafica_fornitori_edit();

// Page init
$libdog_anagrafica_fornitori_edit->Page_Init();

// Page main
$libdog_anagrafica_fornitori_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$libdog_anagrafica_fornitori_edit->Page_Render();
?>
...
var CurrentForm = flibdog_anagrafica_fornitoriedit = new ew_Form("flibdog_anagrafica_fornitoriedit", "edit");

// Validate form
flibdog_anagrafica_fornitoriedit.Validate = function() {
...
flibdog_anagrafica_fornitoriedit.Form_CustomValidate = 
...
flibdog_anagrafica_fornitoriedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $libdog_anagrafica_fornitori_edit->ShowPageHeader(); ?>
<?php
$libdog_anagrafica_fornitori_edit->ShowMessage();
?>
<form name="flibdog_anagrafica_fornitoriedit" id="flibdog_anagrafica_fornitoriedit" class="<?php echo $libdog_anagrafica_fornitori_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($libdog_anagrafica_fornitori_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $libdog_anagrafica_fornitori_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="libdog_anagrafica_fornitori">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($libdog_anagrafica_fornitori_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->Visible) { // idlibdog_Anagrafica_Fornitori ?>
	<div id="r_idlibdog_Anagrafica_Fornitori" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_idlibdog_Anagrafica_Fornitori" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->CellAttributes() ?>>
<span id="el_libdog_anagrafica_fornitori_idlibdog_Anagrafica_Fornitori">
<span<?php echo $libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->EditValue ?></p></span>
</span>
<input type="hidden" data-table="libdog_anagrafica_fornitori" data-field="x_idlibdog_Anagrafica_Fornitori" name="x_idlibdog_Anagrafica_Fornitori" id="x_idlibdog_Anagrafica_Fornitori" value="<?php echo ew_HtmlEncode($libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->CurrentValue) ?>">
<?php echo $libdog_anagrafica_fornitori->idlibdog_Anagrafica_Fornitori->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($libdog_anagrafica_fornitori->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_name" for="x_name" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->name->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->name->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->PI->Visible) { // PI ?>
	<div id="r_PI" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_PI" for="x_PI" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->PI->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->PI->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->town->Visible) { // town ?>
	<div id="r_town" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_town" for="x_town" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->town->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->town->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_address" for="x_address" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->address->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->address->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->zip->Visible) { // zip ?>
	<div id="r_zip" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_zip" for="x_zip" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->zip->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->zip->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->prov->Visible) { // prov ?>
	<div id="r_prov" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_prov" for="x_prov" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->prov->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->prov->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->mail->Visible) { // mail ?>
	<div id="r_mail" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_mail" for="x_mail" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->mail->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->mail->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->mobile->Visible) { // mobile ?>
	<div id="r_mobile" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_mobile" for="x_mobile" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->mobile->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->mobile->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_phone" for="x_phone" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->phone->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->phone->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->CF->Visible) { // CF ?>
	<div id="r_CF" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_CF" for="x_CF" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->CF->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->CF->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->mobile2->Visible) { // mobile2 ?>
	<div id="r_mobile2" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_mobile2" for="x_mobile2" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->mobile2->FldCaption() ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->mobile2->CellAttributes() ?>>
...
<?php if ($libdog_anagrafica_fornitori->mail2->Visible) { // mail2 ?>
	<div id="r_mail2" class="form-group">
		<label id="elh_libdog_anagrafica_fornitori_mail2" for="x_mail2" class="<?php echo $libdog_anagrafica_fornitori_edit->LeftColumnClass ?>"><?php echo $libdog_anagrafica_fornitori->mail2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $libdog_anagrafica_fornitori_edit->RightColumnClass ?>"><div<?php echo $libdog_anagrafica_fornitori->mail2->CellAttributes() ?>>
...
<?php if (!$libdog_anagrafica_fornitori_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $libdog_anagrafica_fornitori_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $libdog_anagrafica_fornitori_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
flibdog_anagrafica_fornitoriedit.Init();
</script>
<?php
$libdog_anagrafica_fornitori_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$libdog_anagrafica_fornitori_edit->Page_Terminate();
?>
